...
if(isset($_GET['delete']))
{
    ...
    $deleteID = $fetchall[$_GET['delete']]['customer_id'];
    $imagename= $fetchall[$_GET['delete']]['Upload_image'];
  ...
  <?php $id=1; foreach ($fetchall as $val){?>
    ...
    <td><?php echo $id?></td>
      ...
      <td> 
          ...
          <!-- <a href="?delete=<?php echo $val['customer_id']; ?>&ImageName=<?php echo $val['Upload_image']; ?>">Delete</a> -->
          <a href="?delete=<?php echo $id-1 ?>">Delete</a>
